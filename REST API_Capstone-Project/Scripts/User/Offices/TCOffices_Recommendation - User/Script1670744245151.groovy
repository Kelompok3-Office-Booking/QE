...
response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Offices Recommendation/TCGet_Offices_Rec_02'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Offices Recommendation/TCGet_Offices_Rec_03'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Offices Recommendation/TCGet_Offices_Rec_04'))
WS.verifyResponseStatusCode(response, 405)