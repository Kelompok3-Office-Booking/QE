...
response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Offices Meeting Room/TCGet_Meeting_Room_02'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Offices Meeting Room/TCGet_Meeting_Room_03'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Offices Meeting Room/TCGet_Meeting_Room_04'))
WS.verifyResponseStatusCode(response, 405)