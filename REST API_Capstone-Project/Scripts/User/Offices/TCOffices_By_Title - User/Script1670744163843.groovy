...
response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Office By Title/TCGet_Offices_By_Title_02'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Office By Title/TCGet_Offices_By_Title_03'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Office By Title/TCGet_Offices_By_Title_04'))
WS.verifyResponseStatusCode(response, 405)
