...
response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Office By Rate/TCGet_Offices_By_Rate_02'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Office By Rate/TCGet_Offices_By_Rate_03'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Office By Rate/TCGet_Offices_By_Rate_04'))
WS.verifyResponseStatusCode(response, 405)
