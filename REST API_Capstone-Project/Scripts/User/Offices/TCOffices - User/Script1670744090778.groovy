...
response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Offices/TCGet_Offices_02'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Offices/TCGet_Offices_03'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Offices/TCGet_Offices_04'))
WS.verifyResponseStatusCode(response, 405)
