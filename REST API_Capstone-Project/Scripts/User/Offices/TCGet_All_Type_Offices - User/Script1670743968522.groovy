...
response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - All Type Of Offices/TCGet_All_Type_Offices_02'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - All Type Of Offices/TCGet_All_Type_Offices_03'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - All Type Of Offices/TCGet_All_Type_Offices_04'))
WS.verifyResponseStatusCode(response, 405)
