...
response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Offices Coworking Space/TCGet_Coworking_Space_02'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Offices Coworking Space/TCGet_Coworking_Space_03'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/User/Offices/GET - Offices Coworking Space/TCGet_Coworking_Space_04'))
WS.verifyResponseStatusCode(response, 405)
