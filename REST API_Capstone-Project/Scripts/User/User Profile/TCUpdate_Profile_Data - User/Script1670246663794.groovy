...
// hit endpoint
response = WS.sendRequest(findTestObject('Object Repository/User/User Profile/PUT - Update Profile Data/TCUpdate_Profile_Data_01'))
WS.verifyResponseStatusCode(response, 200)

response = WS.sendRequest(findTestObject('Object Repository/User/User Profile/PUT - Update Profile Data/TCUpdate_Profile_Data_02'))
WS.verifyResponseStatusCode(response, 400)

response = WS.sendRequest(findTestObject('Object Repository/User/User Profile/PUT - Update Profile Data/TCUpdate_Profile_Data_03'))
WS.verifyResponseStatusCode(response, 400)
