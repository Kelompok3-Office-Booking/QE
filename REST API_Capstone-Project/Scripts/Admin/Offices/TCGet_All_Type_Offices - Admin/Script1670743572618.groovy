...
response = WS.sendRequest(findTestObject('Object Repository/Admin/Offices/GET - all types of offices/TCGet_All_Offices_02'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/Admin/Offices/GET - all types of offices/TCGet_All_Offices_03'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/Admin/Offices/GET - all types of offices/TCGet_All_Offices_04'))
WS.verifyResponseStatusCode(response, 405)
