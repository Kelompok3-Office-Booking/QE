...
response = WS.sendRequest(findTestObject('Object Repository/Admin/Offices/DELETE - Delete Offices/TCDelete_Offices_02'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/Admin/Offices/DELETE - Delete Offices/TCDelete_Offices_03'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/Admin/Offices/DELETE - Delete Offices/TCDelete_Offices_04'))
WS.verifyResponseStatusCode(response, 405)
