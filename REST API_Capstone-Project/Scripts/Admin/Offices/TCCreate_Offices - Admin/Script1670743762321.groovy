...
response = WS.sendRequest(findTestObject('Object Repository/Admin/Offices/POST - Create Offies/TCCreate_Offices_02'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/Admin/Offices/POST - Create Offies/TCCreate_Offices_03'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/Admin/Offices/POST - Create Offies/TCCreate_Offices_04'))
WS.verifyResponseStatusCode(response, 405)
