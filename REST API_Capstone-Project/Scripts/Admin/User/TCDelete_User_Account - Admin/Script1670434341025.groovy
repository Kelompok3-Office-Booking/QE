...
//
//response = WS.sendRequest(findTestObject('Object Repository/Admin/User/DELETE - User Account/TCDelete_User_Account_03'))
//WS.verifyResponseStatusCode(response, 405)
//
//response = WS.sendRequest(findTestObject('Object Repository/Admin/User/DELETE - User Account/TCDelete_User_Account_04'))
//WS.verifyResponseStatusCode(response, 405)

//response = WS.sendRequest(findTestObject('Object Repository/Admin/User/DELETE - User Account/TCDelete_User_Account_05'))
//WS.verifyResponseStatusCode(response, 405)