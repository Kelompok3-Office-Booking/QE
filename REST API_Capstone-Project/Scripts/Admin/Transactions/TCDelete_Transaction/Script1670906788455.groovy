...
response = WS.sendRequest(findTestObject('Object Repository/Admin/Transaction/DELETE - Delete Transaction/TCDelete_Transaction_03'))
WS.verifyResponseStatusCode(response, 405)

// 200
//response = WS.sendRequest(findTestObject('Object Repository/Admin/Transaction/DELETE - Delete Transaction/TCDelete_Transaction_04'))
//WS.verifyResponseStatusCode(response, 405)
