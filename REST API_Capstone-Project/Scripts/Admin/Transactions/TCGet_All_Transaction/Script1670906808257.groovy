...
response = WS.sendRequest(findTestObject('Object Repository/Admin/Transaction/GET - All Transaction/TCGet_All_Transaction_02'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/Admin/Transaction/GET - All Transaction/TCGet_All_Transaction_03'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/Admin/Transaction/GET - All Transaction/TCGet_All_Transaction_04'))
WS.verifyResponseStatusCode(response, 405)
