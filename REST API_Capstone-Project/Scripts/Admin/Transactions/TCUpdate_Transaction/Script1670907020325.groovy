...
//200
//response = WS.sendRequest(findTestObject('Object Repository/Admin/Transaction/PUT - Update Transaction/TCUpdate_Transaction_02'))
//WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/Admin/Transaction/PUT - Update Transaction/TCUpdate_Transaction_03'))
WS.verifyResponseStatusCode(response, 405)

// 200
//response = WS.sendRequest(findTestObject('Object Repository/Admin/Transaction/PUT - Update Transaction/TCUpdate_Transaction_04'))
//WS.verifyResponseStatusCode(response, 405)
