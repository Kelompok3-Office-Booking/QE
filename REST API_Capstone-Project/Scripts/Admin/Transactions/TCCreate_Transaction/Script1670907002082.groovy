...
response = WS.sendRequest(findTestObject('Object Repository/Admin/Transaction/POST - Create Transaction/TCCreate_Transaction_02'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/Admin/Transaction/POST - Create Transaction/TCCreate_Transaction_03'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/Admin/Transaction/POST - Create Transaction/TCCreate_Transaction_04'))
WS.verifyResponseStatusCode(response, 405)
