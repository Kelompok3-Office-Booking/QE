...
// 404
//response = WS.sendRequest(findTestObject('Object Repository/Admin/Facilities/POST - Create Facilities/TCCreate_Facility_02'))
//WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/Admin/Facilities/POST - Create Facilities/TCCreate_Facility_03'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/Admin/Facilities/POST - Create Facilities/TCCreate_Facility_04'))
WS.verifyResponseStatusCode(response, 405)
