...
response = WS.sendRequest(findTestObject('Object Repository/Admin/Facilities/GET - All Facilities/TCGet_All_Facilities_02'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/Admin/Facilities/GET - All Facilities/TCGet_All_Facilities_03'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/Admin/Facilities/GET - All Facilities/TCGet_All_Facilities_04'))
WS.verifyResponseStatusCode(response, 405)
