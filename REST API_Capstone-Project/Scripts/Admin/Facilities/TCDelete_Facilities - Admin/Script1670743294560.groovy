...
// 404
//response = WS.sendRequest(findTestObject('Object Repository/Admin/Facilities/DELETE - Delete Facilities/TCDelete_Facilities_02'))
//WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/Admin/Facilities/DELETE - Delete Facilities/TCDelete_Facilities_03'))
WS.verifyResponseStatusCode(response, 405)

response = WS.sendRequest(findTestObject('Object Repository/Admin/Facilities/DELETE - Delete Facilities/TCDelete_Facilities_04'))
WS.verifyResponseStatusCode(response, 405)
